...
def get_prompt_evaluation(recipe_text):
    ...
    Your task is to evaluate AI-generated recipes using the following criteria from 1 (poor) to 5 (excellent):
...
Provide a JSON-style response with scores.
"""
